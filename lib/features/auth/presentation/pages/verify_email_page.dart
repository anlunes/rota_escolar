...
class _VerifyEmailPageState extends State<VerifyEmailPage> {
  ...
  Future<void> _verify() async {
    ...
    try {
      final dio = Dio();
      await dio.post(
        '${ApiConstants.baseUrl}${ApiConstants.authVerifyEmail}',
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('E-mail verificado! Faça login para continuar.'),
  ...
  Future<void> _resend() async {
    ...
    try {
      final dio = Dio();
      await dio.post(
        '${ApiConstants.baseUrl}${ApiConstants.authSendVerification}',
        data: {'email': widget.email, 'nome': widget.nome},
      );
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
